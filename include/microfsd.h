...
unsigned short __far __cdecl stub_mu_Open(char far *pName, unsigned long far *pulFileSize);
unsigned long  __cdecl mu_Read(long loffseek, char far *pBuf, unsigned long cbBuf);
unsigned long  __far __cdecl stub_mu_Read(long loffseek, char far *pBuf, unsigned long cbBuf);
void __cdecl mu_Close(void);
void __far __cdecl stub_mu_Close(void);
void __cdecl mu_Terminate(void);
void __far __cdecl stub_mu_Terminate(void);
void __cdecl mu_Mount (void);
void __far __cdecl stub_mu_Mount (void);
...
extern void __cdecl microfsd_panic(const char *format, ...);
 ...
 * From entry.asm
 */
extern int __pascal bios_read_hd(
                        unsigned short dev,
                        unsigned short head,
                        unsigned short cyl,
                        unsigned short sect,
