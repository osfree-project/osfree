...
struct hpfs_dirent {
  ...
  unsigned short first: 1;                    /* set on phony ^A^A (".") entry */
  unsigned short has_acl: 1;
  unsigned short down: 1;                     /* down pointer present (after name) */
  unsigned short last: 1;                     /* set on phony \377 entry */
  unsigned short has_ea: 1;                   /* entry has EA */
  unsigned short has_xtd_perm: 1;             /* has extended perm list (???) */
  unsigned short has_explicit_acl: 1;
  unsigned short has_needea: 1;               /* ?? some EA has NEEDEA set
                                           I have no idea why this is
                                           interesting in a dir entry */
  unsigned short read_only: 1;                /* dos attrib */
  unsigned short hidden: 1;                   /* dos attrib */
  unsigned short system: 1;                   /* dos attrib */
  unsigned short flag11: 1;                   /* would be volume label dos attrib */
  unsigned short directory: 1;                /* dos attrib */
