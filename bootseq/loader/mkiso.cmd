...
@%mkisofs% -b boot/bootblk -c boot/bootcat.bin -no-emul-boot -boot-info-table -boot-load-size 4 -iso-level 3 -relaxed-filenames -r -J -joliet-long -l -D -N -v -x .DS_Store -publisher "osFree (www.osfree.org)" -o %imgdir1%/osfree.iso cd
