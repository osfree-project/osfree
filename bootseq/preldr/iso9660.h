...
typedef _Packed struct __iso_16bit {
  u_int16_t l, b;
} iso_16bit_t; //__attribute__ ((packed));

typedef _Packed struct __iso_32bit {
  u_int32_t l, b;
} iso_32bit_t; //__attribute__ ((packed));

typedef u_int8_t                iso_date_t[7];

_Packed struct iso_directory_record {
  iso_8bit_t    length;
...
_Packed struct iso_primary_descriptor {
  iso_8bit_t    type;
  u_int8_t      id[5];
  iso_8bit_t    version;
  u_int8_t      _unused1[1];
