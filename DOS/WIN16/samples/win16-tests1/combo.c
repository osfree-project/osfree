/* Win16 Unit test suite for combo boxes.
 *
 * Copyright 2007 Google, Jennifer Lai
 * Modified from /wine-git/dlls/user32/tests/combo.c
...
/* this test needs to be compiled in a large memory mode */
#include <assert.h>
#include <stdarg.h>
#include <stdio.h>
...
static void test_setitemheight(DWORD style)
{
    ...
    SendMessage(hCombo, CB_GETDROPPEDCONTROLRECT, 0, (LPARAM)&r);
