...
#define     GlobalPtrHandle(lp)         \
                ((HGLOBAL)LOWORD(GlobalHandle32(lp)))
...
#define	GET_WM_MDISETMENU_HMENUF(wp, lp)	    (HMENU)LOWORD(lp)
#define	GET_WM_MDISETMENU_HMENUW(wp, lp)	    (HMENU)HIWORD(lp)
...
#define     TWIN_GetWindowID(hwnd)	    ((UINT)GetWindowWord(hwnd,GWW_ID))
#define     SetWindowID(hwnd,id)    (WORD)SetWindowWord(hwnd,GWW_ID,(WORD)id)

#define	    GetClassBackBrush(hWnd) ((HBRUSH)GetClassWord(hWnd,GCW_HBRBACKGROUND))
#define	    SetClassBackBrush(hWnd,hBr) ((HBRUSH)SetClassWord(hWnd,GCW_HBRBACKGROUND,(WORD)hBr))
#define	    GetClassIcon(hWnd)      ((HICON)GetClassWord(hWnd,GCW_HICON))
#define	    SetClassIcon(hWnd,hIcon) ((HICON)SetClassWord(hWnd,GCW_HICON,(WORD)hIcon))
#define	    GetClassCursor(hWnd)    ((HCURSOR)GetClassWord(hWnd,GCW_HCURSOR))
#define	    SetClassCursor(hWnd,hCur) ((HCURSOR)SetClassWord(hWnd,GCW_HCURSOR,(WORD)hCur))
#define	    GetClassStyle(hWnd)      (GetClassWord(hWnd,GCW_STYLE))
#define	    SetClassStyle(hWnd,w)   (SetClassWord(hWnd,GCW_STYLE,(WORD)w))
