...
#define	GET_WM_MDISETMENU_HMENUF(wp, lp)	    (HMENU)(wp)
#define	GET_WM_MDISETMENU_HMENUW(wp, lp)	    (HMENU)(lp)
...
#define	    SetWindowExStyle(hwnd,style) ((DWORD)SetWindowLong(hwnd, GWL_EXSTYLE, style))

#define     TWIN_GetWindowID(hwnd)	    ((UINT)GetWindowLong(hwnd,GWL_ID))
#define     SetWindowID(hwnd,id)    (LONG)SetWindowLong(hwnd,GWL_ID,(LONG)id)

#define	    GetClassBackBrush(hWnd) ((HBRUSH)GetClassLong(hWnd,GCL_HBRBACKGROUND))
#define	    SetClassBackBrush(hWnd,hBr) ((HBRUSH)SetClassLong(hWnd,GCL_HBRBACKGROUND,(LONG)hBr))
#define	    GetClassIcon(hWnd)      ((HICON)GetClassLong(hWnd,GCL_HICON))
#define	    SetClassIcon(hWnd,hIcon) ((HICON)SetClassLong(hWnd,GCL_HICON,(LONG)hIcon))
#define	    GetClassCursor(hWnd)    ((HCURSOR)GetClassLong(hWnd,GCL_HCURSOR))
#define	    SetClassCursor(hWnd,hCur) ((HCURSOR)SetClassLong(hWnd,GCL_HCURSOR,(LONG)hCur))
#define	    GetClassStyle(hWnd)      (GetClassLong(hWnd,GCL_STYLE))
#define	    SetClassStyle(hWnd,dw)   (SetClassLong(hWnd,GCL_STYLE,(LONG)dw))
