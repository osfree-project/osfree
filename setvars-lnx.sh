...
VARS="OS OS_SHELL REXX REXX_PATH WATCOM ROOT TOOLS INCLUDE LIB PATH WD_PATH LANG WIPFC"

export VARS OS OS_SHELL REXX REXX_PATH WATCOM ROOT TOOLS INCLUDE LIB PATH WD_PATH LANG WIPFC
