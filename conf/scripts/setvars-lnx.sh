...
VARS="OS SHELL REXX REXX_PATH ENV WATCOM ROOT TOOLS INCLUDE LIB PATH WD_PATH LANG WIPFC SERVERENV FPC ARCH _CWD LOG"

export VARS OS SHELL REXX REXX_PATH ENV WATCOM ROOT TOOLS INCLUDE LIB PATH WD_PATH LANG WIPFC SERVERENV FPC ARCH _CWD LOG
