...
typedef int        (*GNodeTraverseFunc)    (GNode         *node,
                                                 void *       data);
...
GNode*   g_node_prepend         (GNode            *parent,
                                 GNode            *node);
unsigned int    g_node_n_nodes         (GNode            *root,
                                 GTraverseFlags    flags);
GNode*   g_node_get_root        (GNode            *node);
int g_node_is_ancestor     (GNode            *node,
                                 GNode            *descendant);
unsigned int    g_node_depth           (GNode            *node);
 ...
 */
unsigned int    g_node_max_height       (GNode *root);
...
GNode*   g_node_find_child       (GNode           *node,
                                  GTraverseFlags   flags,
                                  void *         data);
int     g_node_child_position   (GNode           *node,
                                  GNode           *child);
int     g_node_child_index      (GNode           *node,
                                  void *         data);
