/* spdx_db_private.h - internal structures of the SPDX database.
...
/** @def SPDXDB_FLAG_OSI @brief License is OSI-approved. */
#define SPDXDB_FLAG_OSI         0x01
/** @def SPDXDB_FLAG_FSF_LIBRE @brief License is FSF-libre. */
#define SPDXDB_FLAG_FSF_LIBRE   0x02
/** @def SPDXDB_FLAG_DEPRECATED @brief Identifier is deprecated. */
