...
VARS="OS SHELL REXX REXX_PATH ENV HOST WATCOM ROOT OS2TK TOOLS INCLUDE LIB PATH WD_PATH LANG WIPFC SERVERENV FPC ARCH _CWD LOG TMP"

export VARS OS SHELL REXX REXX_PATH ENV HOST WATCOM ROOT OS2TK TOOLS INCLUDE LIB PATH WD_PATH LANG WIPFC SERVERENV FPC ARCH _CWD LOG TMP
