...
/* ------------------------------------------------------------------ */
/* Проверка уже существующих тегов                                     */
/* ------------------------------------------------------------------ */

/* Проверяет, есть ли в файле SPDX-License-Identifier вне блоков
 * REUSE-IgnoreStart / REUSE-IgnoreEnd. Учитывает случай, когда оба
 * маркера оказались на одной строке — обрабатывает их в порядке
 * появления. */
