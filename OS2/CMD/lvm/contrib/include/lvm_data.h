...
typedef struct _DLA_Entry { /* DE */
                             DoubleWord  Volume_Serial_Number;                        /* The serial number of the volume that t
...
{ /* DTS */
   ...
   DoubleWord   DLA_CRC;                 /* The 32 bit CRC for this sector.  Calculated assuming that this */
                                         /* field and all unused space in the sector is 0. */
   DoubleWord   Disk_Serial_Number;      /* The serial number assigned to this disk. */
   DoubleWord   Boot_Disk_Serial_Number; /* The serial number of the disk used to boot the system.  
