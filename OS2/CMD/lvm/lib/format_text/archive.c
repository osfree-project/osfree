...
static void _insert_archive_file(struct list *head, struct archive_file *b)
{
        ...
        list_iterate_items(bf, struct archive_file, head) {
                if (b->index > bf->index) {
                            ...
                            uint32_t retain_days, uint32_t min_archive)
{
        ...
        list_iterate_back_items(bf, struct archive_file, archives) {
...
int archive_list(struct cmd_context *cmd, const char *dir, const char *vgname)
{
        ...
        list_iterate_back_items(af, struct archive_file, archives)
