       ...
       )
    {
                                   ...
                                   &uconv_object) == ULS_SUCCESS)
        {
                                        ...
                                        &locale_object) == ULS_SUCCESS)
            {
				...
				itemList[0].lclItem=LOCI_s2359;
				itemList[0].vTarget=&pampm->sz2359;
				itemList[0].iType=3;
				
                itemList[1].lclItem=LOCI_s1159;
				itemList[1].vTarget=&pampm->sz1159;
				itemList[1].iType=3;
           ...
           )
        {
                                       ...
                                       &uconv_object) == ULS_SUCCESS)
            {
                                            ...
                                            &locale_object) == ULS_SUCCESS)
                {
					...
					itemList[0].lclItem=LOCI_iDate;
					itemList[0].vTarget=&pcs->ulDateFormat;
					itemList[0].iType=1;
					
					itemList[1].lclItem=LOCI_iTime;
					itemList[1].vTarget=&pcs->ulTimeFormat;
					itemList[1].iType=1;
					
					itemList[2].lclItem=LOCI_sDate;
					itemList[2].vTarget=&pcs->cDateSep;
					itemList[2].iType=2;
					
					itemList[3].lclItem=LOCI_sTime;
					itemList[3].vTarget=&pcs->cTimeSep;
					itemList[3].iType=2;
					
					itemList[4].lclItem=LOCI_sDecimal;
					itemList[4].vTarget=&pcs->cDecimal;
					itemList[4].iType=2;
					
					itemList[5].lclItem=LOCI_sThousand;
					itemList[5].vTarget=&pcs->cThousands;
					itemList[5].iType=2;
