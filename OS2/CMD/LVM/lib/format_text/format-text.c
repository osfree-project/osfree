...
static int _scan_file(const struct format_type *fmt)
{
        ...
        list_iterate_items(dl, struct dir_list, dir_list) {
                if (!(d = opendir(dl->dir))) {
...
static int _scan_raw(const struct format_type *fmt)
{
        ...
        list_iterate_items(rl, struct raw_list, raw_list) {
                     ...
                     struct list *mdas, int64_t label_sector)
{
        ...
        if (mdas) {
                ...
                list_iterate_items(mda, struct metadata_area, mdas) {
                     ...
                     struct physical_volume *pv, struct volume_group *vg)
{
        ...
        if (vg) {
                ...
                if ((info = info_from_pvid(pv->dev->pvid))) {
                        ...
                        list_iterate_items(mda, struct metadata_area, pvmdas) {
                                mda_count++;
                                mdac =
                                ...
                                list_iterate_items(mda2, struct metadata_area, mdas) {
                                        if (mda2->ops !=
