...
#define INCL_GRE_LINES
   ...
   #define GreDisjointLines(a,b,c) (INT) GreEntry5((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),(ULONG)(LONG)(c),0L,NGreDisjointLines)
   #define NGreGetCurrentPosition 0x00004017L
   #define GreGetCurrentPosition(a,b) (BOOL) GreEntry4((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),0L,NGreGetCurrentPosition)
   #define NGreSetCurrentPosition 0x00004018L
   #define GreSetCurrentPosition(a,b) (BOOL) GreEntry4((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),0L,NGreSetCurrentPosition)
   #define NGrePolyLine 0x00004019L
   #define GrePolyLine(a,b,c) (INT) GreEntry5((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),(ULONG)(LONG)(c),0L,NGrePolyLine)
   #define NGreDrawLinesInPath 0x0000401AL
   #define GreDrawLinesInPath(a,b,c,d) (BOOL) GreEntry6((ULONG)(HDC)(a),(ULONG)(PPATH)(b),(ULONG)(PCURVE)(c),(ULONG)(LONG)(d),0L,NGreDrawLinesInPath)
   #define NGrePolyShortLine 0x0000401BL
   #define GrePolyShortLine(a,b) (INT) GreEntry4((ULONG)(HDC)(a),(ULONG)(PSHORTLINE)(b),0L,NGrePolyShortLine)
#endif

#ifdef INCL_GRE_POLYGON
   #define NGrePolygonSet 0x00004056L
   #define GrePolygonSet(a,b,c,d,e) (ULONG) GreEntry7((ULONG)(HDC)(a),(ULONG)(b),(ULONG)(c),(ULONG)(PPOLYGON)(d),(ULONG)(e),0L,NGrePolygonSet)
   #define NGreDrawRLE 0x00004058L
   #define GreDrawRLE(a,b) (ULONG) GreEntry4((ULONG)(HDC)(a),(ULONG)(PRLEHDR)(b),0L,NGreDrawRLE)
   #define NGreDevicePolygonSet 0x00004059L
   #define GreDevicePolygonSet(a,b) GreEntry4((ULONG)(HDC)(a),(ULONG)(PPOLYSET)(b),0L,NGreDevicePolygonSet)
   ...
   #define GreGetArcParameters(a,b) (BOOL) GreEntry4((ULONG)(HDC)(a),(ULONG)(PARCPARAMS)(b),0L,NGreGetArcParameters)
   #define NGreSetArcParameters 0x00004001L
   #define GreSetArcParameters(a,b) (BOOL) GreEntry4((ULONG)(HDC)(a),(ULONG)(PARCPARAMS)(b),0L,NGreSetArcParameters)
   #define NGreArc 0x00004002L
   #define GreArc(a,b) (INT) GreEntry4((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),0L,NGreArc)
   #define NGrePartialArc 0x00004003L
   #define GrePartialArc(a,b,c,d,e) (INT) GreEntry7((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),(ULONG)(FIXED)(c),(ULONG)(FIXED)(d),(ULONG)(FIXED)(e),0L,NGrePartialArc)
   #define NGreFullArcInterior 0x00004004L
   #define GreFullArcInterior(a,b) (INT) GreEntry4((ULONG)(HDC)(a),(ULONG)(FIXED)(b),0L,NGreFullArcInterior)
   #define NGreFullArcBoundary 0x00004005L
   #define GreFullArcBoundary(a,b) (INT) GreEntry4((ULONG)(HDC)(a),(ULONG)(FIXED)(b),0L,NGreFullArcBoundary)
   #define NGreFullArcBoth 0x00004006L
   #define GreFullArcBoth(a,b) (INT) GreEntry4((ULONG)(HDC)(a),(ULONG)(FIXED)(b),0L,NGreFullArcBoth)
   #define NGreBoxInterior 0x00004007L
   #define GreBoxInterior(a,b) (INT) GreEntry4((ULONG)(HDC)(a),(ULONG)(PBOXPARAMS)(b),0L,NGreBoxInterior)
   #define NGreBoxBoundary 0x00004008L
   #define GreBoxBoundary(a,b) (INT) GreEntry4((ULONG)(HDC)(a),(ULONG)(PBOXPARAMS)(b),0L,NGreBoxBoundary)
   #define NGreBoxBoth 0x00004009L
   #define GreBoxBoth(a,b) (INT) GreEntry4((ULONG)(HDC)(a),(ULONG)(PBOXPARAMS)(b),0L,NGreBoxBoth)
   #define NGreBoxExclusive 0x00004010L
   #define GreBoxExclusive(a,b,c) (INT) GreEntry5((ULONG)(HDC)(a),(ULONG)(PBOXPARAMS)(b),(ULONG)(c),0L,NGreBoxExclusive)
   #define NGrePolyFillet 0x0000400AL
   #define GrePolyFillet(a,b,c) (INT) GreEntry5((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),(ULONG)(LONG)(c),0L,NGrePolyFillet)
   #define NGrePolyFilletSharp 0x0000400BL
   #define GrePolyFilletSharp(a,b,c,d) (INT) GreEntry6((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),(ULONG)(LONG)(c),(ULONG)(PFIXED)(d),0L,NGrePolyFilletSharp)
   #define NGrePolySpline 0x0000400CL
   #define GrePolySpline(a,b,c) (INT) GreEntry5((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),(ULONG)(LONG)(c),0L,NGrePolySpline)
   #define NGreOval 0x0000400DL
   #define GreOval(a,b,c,d,e) (INT) GreEntry7((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),(ULONG)(FIXED)(c),(ULONG)(FIXED)(d),(ULONG)(e),0L,NGreOval)
   #define NGreCookWholePath 0x0000400EL
   #define GreCookWholePath(a,b) (BOOL) GreEntry4((ULONG)(HDC)(a),(ULONG)(PPATH)(b),0L,NGreCookWholePath)
   #define NGreCookPathCurves 0x0000400FL
   #define GreCookPathCurves(a,b,c) (BOOL) GreEntry5((ULONG)(HDC)(a),(ULONG)(PPATH)(b),(ULONG)(PPIPELINEINFO)(c),0L,NGreCookPathCurves)
   #define NGreRenderPath 0x00004011L
   #define GreRenderPath(a,b,c,d,e,f,g,h) (BOOL) GreEntry10((ULONG)(HDC)(a),(ULONG)(PPATH)(b),(ULONG)(PCURVE)(c),(ULONG)(LONG)(d),(ULONG)(LONG)(e),(ULONG)(LONG)(f),(ULONG)(PSHORTLINE)(g),(ULONG)(LONG)(h),0L,NGreRenderPath)
#endif

#ifdef INCL_GRE_REGIONS
   #define NGreGetRegionBox 0x0000405DL
   #define GreGetRegionBox(a,b,c) (INT) GreEntry5((ULONG)(HDC)(a),(ULONG)(HRGN)(b),(ULONG)(PRECTL)(c),0L,NGreGetRegionBox)
   #define NGreGetRegionRects 0x0000405EL
   #define GreGetRegionRects(a,b,c,d,e) (BOOL) GreEntry7((ULONG)(HDC)(a),(ULONG)(HRGN)(b),(ULONG)(PRECTL)(c),(ULONG)(PRGNRECT)(d),(ULONG)(PRECTL)(e),0L,NGreGetRegionRects)
   #define NGreOffsetRegion 0x0000405FL
   #define GreOffsetRegion(a,b,c) (BOOL) GreEntry5((ULONG)(HDC)(a),(ULONG)(HRGN)(b),(ULONG)(PPOINTL)(c),0L,NGreOffsetRegion)
   #define NGrePtInRegion 0x00004060L
   #define GrePtInRegion(a,b,c) (INT) GreEntry5((ULONG)(HDC)(a),(ULONG)(HRGN)(b),(ULONG)(PPOINTL)(c),0L,NGrePtInRegion)
   #define NGreRectInRegion 0x00004061L
   #define GreRectInRegion(a,b,c) (INT) GreEntry5((ULONG)(HDC)(a),(ULONG)(HRGN)(b),(ULONG)(PRECTL)(c),0L,NGreRectInRegion)
   #define NGreCreateRectRegion 0x00004062L
   #define GreCreateRectRegion(a,b,c) (HRGN) GreEntry5((ULONG)(HDC)(a),(ULONG)(PRECTL)(b),(ULONG)(LONG)(c),0L,NGreCreateRectRegion)
   #define NGreDestroyRegion 0x00004063L
   #define GreDestroyRegion(a,b) (BOOL) GreEntry4((ULONG)(HDC)(a),(ULONG)(HRGN)(b),0L,NGreDestroyRegion)
   #define NGreSetRectRegion 0x00004064L
   #define GreSetRectRegion(a,b,c,d) (BOOL) GreEntry6((ULONG)(HDC)(a),(ULONG)(HRGN)(b),(ULONG)(PRECTL)(c),(ULONG)(LONG)(d),0L,NGreSetRectRegion)
   #define NGreCombineRegion 0x00004065L
   #define GreCombineRegion(a,b,c,d,e) (INT) GreEntry7((ULONG)(HDC)(a),(ULONG)(HRGN)(b),(ULONG)(HRGN)(c),(ULONG)(HRGN)(d),(ULONG)(ULONG)(e),0L,NGreCombineRegion)
   #define NGreCombineRectRegion 0x00004066L
   #define GreCombineRectRegion(a,b,c,d,e) (INT) GreEntry7((ULONG)(HDC)(a),(ULONG)(HRGN)(b),(ULONG)(PRECTL)(c),(ULONG)(HRGN)(d),(ULONG)(ULONG)(e),0L,NGreCombineRectRegion)
   #define NGreCombineShortLineRegion 0x00004067L
   #define GreCombineShortLineRegion(a,b,c) (INT) GreEntry5((ULONG)(HDC)(a),(ULONG)(HRGN)(b),(ULONG)(PSHORTLINE)(c),0L,NGreCombineShortLineRegion)
   #define NGreEqualRegion 0x00004068L
   #define GreEqualRegion(a,b,c) (INT) GreEntry5((ULONG)(HDC)(a),(ULONG)(HRGN)(b),(ULONG)(HRGN)(c),0L,NGreEqualRegion)
   #define NGrePaintRegion 0x00004069L
   #define GrePaintRegion(a,b) (INT) GreEntry4((ULONG)(HDC)(a),(ULONG)(HRGN)(b),0L,NGrePaintRegion)
   #define NGreSetRegionOwner 0x0000406AL
   #define GreSetRegionOwner(a,b,c) (BOOL) GreEntry5((ULONG)(HDC)(a),(ULONG)(HRGN)(b),(ULONG)(ULONG)(c),0L,NGreSetRegionOwner)
   #define NGreFrameRegion 0x0000406BL
   #define GreFrameRegion(a,b,c) (INT) GreEntry5((ULONG)(HDC)(a),(ULONG)(HRGN)(b),(ULONG)(PSIZEL)(c),0L,NGreFrameRegion)
#endif

#ifdef INCL_GRE_BITMAPS
   #define NGreDrawBits 0x00006022L
   #define GreDrawBits(a,b,c,d,e,f,g) (LONG) GreEntry9((ULONG)(HDC)(a),(ULONG)(PBYTE)(b),(ULONG)(PBITMAPINFO2)(c),(ULONG)(LONG)(d),(ULONG)(PPOINTL)(e),(ULONG)(LONG)(f),(ULONG)(ULONG)(g),0L,NGreDrawBits)
   #define NGreDeviceCreateBitmap 0x00006023L
   #define GreDeviceCreateBitmap(a,b,c,d,e) (HBITMAP) GreEntry7((ULONG)(HDC)(a),(ULONG)(PBITMAPINFOHEADER2)(b),(ULONG)(ULONG)(c),(ULONG)(PBYTE)(d),(ULONG)(PBITMAPINFO2)(e),0L,NGreDeviceCreateBitmap)
   #define NGreDeviceDeleteBitmap 0x00004024L
   #define GreDeviceDeleteBitmap(a,b,c,d) (BOOL) GreEntry6((ULONG)(HDC)(a),(ULONG)(HBITMAP)(b),(ULONG)(PDELETERETURN)(c),(ULONG)(ULONG)(d),0L,NGreDeviceDeleteBitmap)
   #define NGreDeviceSelectBitmap 0x00004025L
   #define GreDeviceSelectBitmap(a,b) (ULONG) GreEntry4((ULONG)(HDC)(a),(ULONG)(HBITMAP)(b),0L,NGreDeviceSelectBitmap)
   #define NGreBitblt 0x00006026L
   #define GreBitblt(a,b,c,d,e,f,g) (INT) GreEntry9((ULONG)(HDC)(a),(ULONG)(HDC)(b),(ULONG)(LONG)(c),(ULONG)(PBITBLTPARAMETERS)(d),(ULONG)(LONG)(e),(ULONG)(ULONG)(f),(ULONG)(PBITBLTATTRS)(g),0L,NGreBitblt)
   #define NGreGetPel 0x00006027L
   #define GreGetPel(a,b) (LONG) GreEntry4((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),0L,NGreGetPel)
   #define NGreSetPel 0x00004028L
   #define GreSetPel(a,b) (INT) GreEntry4((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),0L,NGreSetPel)
   #define NGreImageData 0x00004029L
   #define GreImageData(a,b,c,d) (INT) GreEntry6((ULONG)(HDC)(a),(ULONG)(PBYTE)(b),(ULONG)(LONG)(c),(ULONG)(LONG)(d),0L,NGreImageData)
   #define NGreScanLR 0x0000602AL
   #define GreScanLR(a,b,c,d,e,f) (INT) GreEntry8((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),(ULONG)(LONG)(c),(ULONG)(LONG)(d),(ULONG)(PLONG)(e),(ULONG)(PLONG)(f),0L,NGreScanLR)
   #define NGreFloodFill 0x0000602BL
   #define GreFloodFill(a,b,c) (INT) GreEntry5((ULONG)(HDC)(a),(ULONG)(LONG)(b),(ULONG)(LONG)(c),0L,NGreFloodFill)
   #define NGreSaveScreenBits 0x0000402CL
   #define GreSaveScreenBits(a,b) (ULONG) GreEntry4((ULONG)(HDC)(a),(ULONG)(PRECTL)(b),0L,NGreSaveScreenBits)
   #define NGreRestoreScreenBits 0x0000402DL
   #define GreRestoreScreenBits(a,b,c,d) (BOOL) GreEntry6((ULONG)(HDC)(a),(ULONG)(LHANDLE)(b),(ULONG)(PRECTL)(c),(ULONG)(ULONG)(d),0L,NGreRestoreScreenBits)
   #define NGreDrawBorder 0x0000602EL
   #define GreDrawBorder(a,b,c,d,e,f,g) (BOOL) GreEntry9((ULONG)(HDC)(a),(ULONG)(PRECTL)(b),(ULONG)(LONG)(c),(ULONG)(LONG)(d),(ULONG)(COLOR)(e),(ULONG)(COLOR)(f),(ULONG)(ULONG)(g),0L,NGreDrawBorder)
   #define NGreDeviceSetCursor 0x0000402FL
   #define GreDeviceSetCursor(a,b,c) (BOOL) GreEntry5((ULONG)(HDC)(a),(ULONG)(PPOINTL)(b),(ULONG)(HBITMAP)(c),0L,NGreDeviceSetCursor)
   #define NGreGetBitmapBits 0x00006030L
   #define GreGetBitmapBits(a,b,c,d,e,f) (LONG) GreEntry8((ULONG)(HDC)(a),(ULONG)(HBITMAP)(b),(ULONG)(LONG)(c),(ULONG)(LONG)(d),(ULONG)(PBYTE)(e),(ULONG)(PBITMAPINFO2)(f),0L,NGreGetBitmapBits)
   #define NGreSetBitmapBits 0x00006031L
   #define GreSetBitmapBits(a,b,c,d,e,f) (LONG) GreEntry8((ULONG)(HDC)(a),(ULONG)(HBITMAP)(b),(ULONG)(LONG)(c),(ULONG)(LONG)(d),(ULONG)(PBYTE)(e),(ULONG)(PBITMAPINFO2)(f),0L,NGreSetBitmapBits)
#endif
   ...
   #define GreCreatePalette(a,b,c,d) (HPAL) GreEntry6((ULONG)(ULONG)(a),(ULONG)(ULONG)(b),(ULONG)(ULONG)(c),(ULONG)(PULONG)(d),0L,NGreCreatePalette)
   #define NGreDeletePalette 0x00000241L
   #define GreDeletePalette(a) (ULONG) GreEntry3((ULONG)(HPAL)(a),0L,NGreDeletePalette)
   #define NGreSelectPalette 0x00004242L
   #define GreSelectPalette(a,b) (ULONG) GreEntry4((ULONG)(HDC)(a),(ULONG)(HPAL)(b),0L,NGreSelectPalette)
   #define NGreSetPaletteEntries 0x00000243L
   #define GreSetPaletteEntries(a,b,c,d,e) (ULONG) GreEntry7((ULONG)(HPAL)(a),(ULONG)(ULONG)(b),(ULONG)(ULONG)(c),(ULONG)(ULONG)(d),(ULONG)(PULONG)(e),0L,NGreSetPaletteEntries)
   #define NGreAnimatePalette 0x00000244L
   #define GreAnimatePalette(a,b,c,d,e) (ULONG) GreEntry7((ULONG)(HPAL)(a),(ULONG)(ULONG)(b),(ULONG)(ULONG)(c),(ULONG)(ULONG)(d),(ULONG)(PULONG)(e),0L,NGreAnimatePalette)
   #define NGreQueryPalette 0x00004245L
   #define GreQueryPalette(a) (ULONG) GreEntry3((ULONG)(HDC)(a),0L,NGreQueryPalette)
   #define NGreQueryPaletteInfo 0x00000246L
   #define GreQueryPaletteInfo(a,b,c,d,e) (ULONG) GreEntry7((ULONG)(HPAL)(a),(ULONG)(ULONG)(b),(ULONG)(ULONG)(c),(ULONG)(ULONG)(d),(ULONG)(PULONG)(e),0L,NGreQueryPaletteInfo)
   #define NGreSetPaletteOwner 0x00000247L
   #define GreSetPaletteOwner(a,b) (BOOL) GreEntry4((ULONG)(HPAL)(a),(ULONG)(ULONG)(b),0L,NGreSetPaletteOwner)
   #define NGreResizePalette 0x00000248L
   #define GreResizePalette(a,b) (ULONG) GreEntry4((ULONG)(HPAL)(a),(ULONG)(ULONG)(b),0L,NGreResizePalette)
   #define NGreQueryDefaultPaletteInfo 0x00004249L
   #define GreQueryDefaultPaletteInfo(a,b,c,d,e) (ULONG) GreEntry7((ULONG)(HDC)(a),(ULONG)(ULONG)(b),(ULONG)(ULONG)(c),(ULONG)(ULONG)(d),(ULONG)(PULONG)(e),0L,NGreQueryDefaultPaletteInfo)
#endif

#ifdef INCL_WINPOINTERS
   #define NGreDeviceSetPointer 0x0000403FL
   #define GreDeviceSetPointer(a,b) (LONG) GreEntry4((a), (PHWSETPTRIN)(b), 0L, NGreDeviceSetPointer)
   #define NGreSetColorCursor 0x00004032L
   #define GreSetColorCursor(a,b) (BOOL) GreEntry4((ULONG)(HDC)(a),(ULONG)(PPOINTERINFO)(b),0L,NGreSetColorCursor)
#endif

#ifdef INCL_GRE_SCANS
   #define NGrePolyScanline 0x0000401CL
   #define GrePolyScanline(a,b) (ULONG) GreEntry4((ULONG)(HDC)(a),(ULONG)(PSCANDATA)(b),0L,NGrePolyScanline)
#endif
