...
/* internal conditional is SOM_Module_test_Source */
#ifndef SOM_Module_test_Header_h
	#define SOM_Module_test_Header_h 1
	#include <som.h>
	...
	typedef struct SOMObjectCClassDataStructure
	{
		...
		#if defined(SOM_Module_test_Source) || defined(SOMObject_Class_Source)
		...
		SOMEXTERN 
				...
				SOMDLLEXPORT
			#endif /* SOMDLLEXPORT */
		#else /* SOM_Module_test_Source || SOMObject_Class_Source */
			#ifdef SOMDLLIMPORT
				SOMDLLIMPORT
			#endif /* SOMDLLIMPORT */
		#endif /* SOM_Module_test_Source || SOMObject_Class_Source */
...
#endif /* SOM_Module_test_Header_h */
