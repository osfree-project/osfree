...
cl /D_USE_SOME_ /DWIN32_LEAN_AND_MEAN /D_WIN32 /DHAVE_CONFIG_HPP /MD /I. rhbsc.cpp rhbidl.cpp rhbscapi.cpp rhbscemt.cpp rhbschdr.cpp rhbscsome.cpp rhbscir.cpp rhbsckih.cpp rhbscpp.cpp rhbsctc.cpp rhbsctyp.cpp somtk.lib some.lib
