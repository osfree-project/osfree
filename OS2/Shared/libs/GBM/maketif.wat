...
CWARNS     = -wx -we
CFLAGS     = $(CWARNS) -i$(ZLIB) -i$(IJG) $(EXTRAFLAGS) -bd -zq -zp4 -onatxh -oe=50 -sg -ei -6r -fp6 -fpi87 -bm -mf /DNDEBUG
CFLAGS_DBG = $(CWARNS) -i$(ZLIB) -i$(IJG) $(EXTRAFLAGS) -bd -zq -zp4 -sg -ei -6r -fp6 -fpi87 -bm -mf -d2 /DDEBUG
...
package:
         -del /N $(IDIR)\libtiff.zip
         zip -9 $(IDIR)\libtiff.zip tiff.lib tiff.h tiffio.h tiffconf.h tif_conf.h
