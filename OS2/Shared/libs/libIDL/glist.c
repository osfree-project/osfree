...
void g_list_push_allocator (void * dummy) { /* present for binary compat only */ }
void g_list_pop_allocator  (void)           { /* present for binary compat only */ }

#define _g_list_alloc()         (GList *)malloc (sizeof(GList))
#define _g_list_alloc0()        (GList *)malloc (sizeof(GList))
...
{
//!!TODO!!  g_slice_free_chain (GList, list, next);
}
