...
{ 
                    ...
                    switch((MATCH_w_8_8 & 0x7) /* r_m at 8 */) {
                      ...
                      case 4: 
                        ...
                        if ((MATCH_w_8_16 & 0x7) /* base at 16 */ == 5 && 
                          ...
                          goto MATCH_label_ab3; 
                          
                        } /*opt-block*/
                        else { 
                          MATCH_w_32_24 = getDword(3 + MATCH_p); 
                          goto MATCH_label_ab2; 
  ...
  MATCH_label_ab1: (void)0; /*placeholder for label*/ 
    { 
      unsigned _a = 1 + addressToPC(MATCH_p);
  ...
  MATCH_label_ab2: (void)0; /*placeholder for label*/ 
    { 
      unsigned _a = 1 + addressToPC(MATCH_p);
  ...
  MATCH_label_ab3: (void)0; /*placeholder for label*/ 
    { 
      unsigned _a = 1 + addressToPC(MATCH_p);
  ...
  MATCH_label_ab4: (void)0; /*placeholder for label*/ 
    { 
      unsigned _a = 1 + addressToPC(MATCH_p);
...
{ 
  ...
  MATCH_label_z1: (void)0; /*placeholder for label*/ 
    { 
      unsigned _a = 1 + addressToPC(MATCH_p);
      int /* [~128..127] */ _b = 
  ...
  MATCH_label_z2: (void)0; /*placeholder for label*/ 
    { 
      unsigned _a = 1 + addressToPC(MATCH_p);
      int /* [~128..127] */ _b = 
  ...
  MATCH_label_z3: (void)0; /*placeholder for label*/ 
    { 
      unsigned _a = 1 + addressToPC(MATCH_p);
      int /* [~128..127] */ _b = 
  ...
  MATCH_label_z4: (void)0; /*placeholder for label*/ 
    { 
      unsigned _a = 1 + addressToPC(MATCH_p);
      int /* [~128..127] */ _b = 
...
#line 93 "machine/pentium/386.pat.m"
}
bool InstructionPatterns::Base(ADDRESS& lc, int& a, bool a_isVAR) {


#line 95 "machine/pentium/386.pat.m"
{ 
  dword MATCH_p = 
  ...
  { 
    ...
    if (0 <= (MATCH_w_8_0 & 0x7) /* r_m at 0 */ && (MATCH_w_8_0 & 0x7) 
      ...
      #line 97 "machine/pentium/386.pat.m"
  ...
  MATCH_label_y0: (void)0; /*placeholder for label*/ 
    ...
    #line 99 "machine/pentium/386.pat.m"
...
#line 103 "machine/pentium/386.pat.m"
}
...
{ 
  ...
  MATCH_label_x0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 110 "machine/pentium/386.pat.m"
...
{ 
  ...
  MATCH_label_w0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 120 "machine/pentium/386.pat.m"
...
#line 123 "machine/pentium/386.pat.m"
}
...
{ 
  ...
  MATCH_label_v0: (void)0; /*placeholder for label*/ 
    ...
    #line 130 "machine/pentium/386.pat.m"
...
#line 133 "machine/pentium/386.pat.m"
}
bool InstructionPatterns::E$Base(ADDRESS& lc, int& a, bool a_isVAR) {


#line 135 "machine/pentium/386.pat.m"
{ 
  dword MATCH_p = 
  ...
  { 
    ...
    if ((MATCH_w_8_0 >> 6 & 0x3) /* mod at 0 */ == 3) 
      ...
      #line 139 "machine/pentium/386.pat.m"
  ...
  MATCH_label_u0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 137 "machine/pentium/386.pat.m"
...
#line 144 "machine/pentium/386.pat.m"
{ 
  dword MATCH_p = 
  ...
  { 
    ...
    if ((MATCH_w_8_0 >> 6 & 0x3) /* mod at 0 */ == 3) 
      ...
      #line 148 "machine/pentium/386.pat.m"
  ...
  MATCH_label_t0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 146 "machine/pentium/386.pat.m"
...
#line 154 "machine/pentium/386.pat.m"
{ 
  dword MATCH_p = 
  ...
  { 
    ...
    if ((MATCH_w_8_0 & 0x7) /* col at 0 */ == 1 && 
      ...
      #line 156 "machine/pentium/386.pat.m"
  ...
  MATCH_label_s0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 158 "machine/pentium/386.pat.m"
...
#line 162 "machine/pentium/386.pat.m"
}
...
#line 174 "machine/pentium/386.pat.m"
}
bool InstructionPatterns::MOVSB(ADDRESS& lc) {
	ADDRESS nextPC;


#line 176 "machine/pentium/386.pat.m"
{ 
  dword MATCH_p = 
  ...
  { 
    ...
    if ((MATCH_w_8_0 & 0x7) /* col at 0 */ == 4 && 
      ...
      #line 178 "machine/pentium/386.pat.m"
  ...
  MATCH_label_q0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 180 "machine/pentium/386.pat.m"
...
#line 184 "machine/pentium/386.pat.m"
}
bool InstructionPatterns::MOVSvow(ADDRESS& lc) {
	ADDRESS nextPC;


#line 186 "machine/pentium/386.pat.m"
{ 
  dword MATCH_p = 
  ...
  { 
    ...
    if (0 <= (MATCH_w_8_0 & 0x7) /* col at 0 */ && (MATCH_w_8_0 & 0x7) 
      ...
      #line 188 "machine/pentium/386.pat.m"
...
{ 
  ...
  MATCH_label_o0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 202 "machine/pentium/386.pat.m"
...
{ 
            ...
            switch((MATCH_w_8_8 >> 6 & 0x3) /* mod at 8 */) {
              ...
              case 1: 
                ...
                if ((MATCH_w_8_8 & 0x7) /* r_m at 8 */ == 4 && 
                  ...
                  #line 210 "machine/pentium/386.pat.m"
  ...
  MATCH_label_n0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 214 "machine/pentium/386.pat.m"
            ...
            switch((MATCH_w_8_8 >> 6 & 0x3) /* mod at 8 */) {
              ...
              case 1: 
                ...
                if ((MATCH_w_8_8 & 0x7) /* r_m at 8 */ == 4 && 
                  ...
                  #line 234 "machine/pentium/386.pat.m"
...
#line 242 "machine/pentium/386.pat.m"
}
...
{ 
  ...
  { 
    ...
    if ((MATCH_w_8_0 >> 4 & 0xf) /* row at 0 */ == 5 && 
      ...
      #line 246 "machine/pentium/386.pat.m"
  ...
  MATCH_label_k0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 249 "machine/pentium/386.pat.m"
...
#line 253 "machine/pentium/386.pat.m"
}
bool InstructionPatterns::PUSHod(ADDRESS& lc, int& a, bool a_isVAR) {
	ADDRESS nextPC;


#line 255 "machine/pentium/386.pat.m"
{ 
  dword MATCH_p = 
  ...
  { 
    ...
    if ((MATCH_w_8_0 >> 4 & 0xf) /* row at 0 */ == 5 && 
      ...
      #line 257 "machine/pentium/386.pat.m"
...
#line 266 "machine/pentium/386.pat.m"
{ 
  dword MATCH_p = 
  ...
  MATCH_label_i0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 270 "machine/pentium/386.pat.m"
...
{ 
  ...
  { 
    ...
    if (0 <= (MATCH_w_8_0 & 0x7) /* col at 0 */ && (MATCH_w_8_0 & 0x7) 
      ...
      #line 278 "machine/pentium/386.pat.m"
...
{ 
  ...
  MATCH_label_g0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 290 "machine/pentium/386.pat.m"
...
#line 294 "machine/pentium/386.pat.m"
}
bool InstructionPatterns::RET$Iw(ADDRESS& lc, int& a, bool a_isVAR) {
	ADDRESS nextPC;


#line 296 "machine/pentium/386.pat.m"
{ 
  dword MATCH_p = 
  ...
  { 
    ...
    if ((MATCH_w_8_0 & 0x7) /* col at 0 */ == 2 && 
      ...
      { 
        ...
        #line 298 "machine/pentium/386.pat.m"
  ...
  MATCH_label_f0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 301 "machine/pentium/386.pat.m"
...
#line 304 "machine/pentium/386.pat.m"
}
...
#line 314 "machine/pentium/386.pat.m"
}
...
{ 
  ...
  MATCH_label_c0: (void)0; /*placeholder for label*/ 
    { 
      ...
      #line 334 "machine/pentium/386.pat.m"
            ...
            switch((MATCH_w_8_8 >> 6 & 0x3) /* mod at 8 */) {
              ...
              case 1: 
                ...
                if ((MATCH_w_8_8 & 0x7) /* r_m at 8 */ == 4 && 
                  ...
                  #line 342 "machine/pentium/386.pat.m"
            ...
            switch((MATCH_w_8_8 >> 6 & 0x3) /* mod at 8 */) {
              ...
              case 1: 
                ...
                if ((MATCH_w_8_8 & 0x7) /* r_m at 8 */ == 4 && 
                  ...
                  #line 354 "machine/pentium/386.pat.m"
...
#line 362 "machine/pentium/386.pat.m"
}
