...
//        l4_taskid_t taskid;
        ...
        int task_status = 0;//l4ts_allocate_task2(0, &taskid);
//        io_printf("Show time! ts=%d, ip=0x0%x, ip=%d, sp=%x\n", task_status, main_ptr, main_ptr, data_mmap+esp);
        int r = l4ts_create_task(&taskid,  main_ptr,  data_mmap+esp, 
                                 0, &pager, 
