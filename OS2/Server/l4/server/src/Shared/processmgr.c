                                 ...
                                 char * pName)
{
  ...
  if (options.debugprcmgr) io_printf("PrcExecuteModule: Loading executable %s\n", pName);
  ...
  if (rc!=0/*NO_ERROR*/)
  {
    io_printf("PrcExecuteModule: Can't find %s module\n", pName);
    return rc;
  }
  ...
  if (rc!=0/*NO_ERROR*/)
  {
    io_printf("PrcExecuteModule: Error identifing %s module\n", pName);
    return rc;
  }
  ...
  if (rc!=0/*NO_ERROR*/)
  {
    io_printf("PrcExecuteModule: Error loading %s module\n", pName);
    return rc;
  }
  ...
  if (rc!=0/*NO_ERROR*/)
  {
    io_printf("PrcExecuteModule: Error %s module fixup\n", pName);
    return rc;
  }
