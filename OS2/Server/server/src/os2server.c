...
int main(int argc, const char **argv)
{
    ...
    {
      printf("Error registering in name server. Exiting.\n");
      return 1;
    }
    ...
    if (parse_cmdline(&argc, &argv,
                      ...
                      0))
    {
      printf("Error command line parsing.\n");
      return 1;
    }
    ...
    {
      printf("Dynamic loader LOADER not found -- terminating\n");
      return -2;
    }
