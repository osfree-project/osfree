...
#define KalGetNamedSharedMem(ppb, pszName, flag)     DlRoute(0, "KalGetNamedSharedMem", ppb, pszName, flag)
#define KalGetSharedMem(pb, flag)                    DlRoute(0, "KalGetSharedMem", pb, flag)
#define KalGiveSharedMem(pb, pid, flag)              DlRoute(0, "KalGiveSharedMem", pb, pid, flag)
