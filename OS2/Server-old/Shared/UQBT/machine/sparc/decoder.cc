    ...
    MATCH_w_32_0 = getDword(MATCH_p); 
      ...
      switch((MATCH_w_32_0 >> 30 & 0x3) /* op at 0 */) {
        ...
        case 1: case 3: 
          goto MATCH_label_c0; break;
        case 2: 
          if ((MATCH_w_32_0 >> 19 & 0x3f) /* op3 at 0 */ == 56) 
            if ((MATCH_w_32_0 >> 13 & 0x1) /* i at 0 */ == 1) 
              
                switch((MATCH_w_32_0 >> 25 & 0x1f) /* rd at 0 */) {
                  case 0: 
                    if ((MATCH_w_32_0 >> 14 & 0x1f) /* rs1 at 0 */ == 31 && 
                      (MATCH_w_32_0 & 0x1fff) /* simm13 at 0 */ == 8) { 
                      nextPC = 4 + MATCH_p; 
                      
#line 799 "machine/sparc/decoder.m"
              ...
              if ((MATCH_w_32_0 >> 25 & 0x1f) /* rd at 0 */ == 15) 
                goto MATCH_label_c4;  /*opt-block+*/
              else 
                goto MATCH_label_c3;  /*opt-block+*/ /*opt-block+*/ 
          else 
...
#line 908 "machine/sparc/decoder.m"
...
#line 853 "machine/sparc/decoder.m"
...
#line 807 "machine/sparc/decoder.m"
...
#line 892 "machine/sparc/decoder.m"
...
#line 784 "machine/sparc/decoder.m"
...
#line 914 "machine/sparc/decoder.m"
...
#line 935 "machine/sparc/decoder.m"
{ 
  dword MATCH_p = 
...
#line 937 "machine/sparc/decoder.m"
...
#line 942 "machine/sparc/decoder.m"
...
#line 947 "machine/sparc/decoder.m"
}
...
#line 961 "machine/sparc/decoder.m"
{ 
  dword MATCH_p = 
...
#line 977 "machine/sparc/decoder.m"
...
#line 980 "machine/sparc/decoder.m"
...
#line 963 "machine/sparc/decoder.m"
...
#line 967 "machine/sparc/decoder.m"
...
#line 989 "machine/sparc/decoder.m"
