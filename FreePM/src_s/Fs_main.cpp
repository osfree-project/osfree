...
BOOL F_PS_GpiSetColor(struct  F_PS *ps, LONG lColor) { return 0; }
BOOL F_PS_GpiLine(struct  F_PS *ps, PPOINTL pptlPoint) { return 0; }
BOOL F_PS_GpiMove(struct  F_PS *ps, PPOINTL pptlPoint) { return 0; }
